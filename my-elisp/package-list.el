...
;;; install packages:
(not-install-package-install 'anything)
...
(not-install-package-install 'company-jedi)
...
(not-install-package-install 'package-utils)
(not-install-package-install 'popup)
(not-install-package-install 'recentf-ext)
...
(not-install-package-install 'tabbar)
